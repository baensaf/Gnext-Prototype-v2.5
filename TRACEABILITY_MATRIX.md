...
| **R3** | Media Asset Storage & Import Engine | `media.service.ts`, `media.controller.ts` | `MediaAsset.entity.ts` | `/api/v1/media/upload` | `/app/catalog/import-export` | `postgres-integration.spec.ts` |
...
| **R22** | Data Reset & Prototype Lifecycle | `tools.service.ts`, `tools.controller.ts` | Reset execution harness | `/api/v1/tools/data-reset` | `/app/settings/data-reset` | `postgres-integration.spec.ts` |
