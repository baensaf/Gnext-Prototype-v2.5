...
// No add-on groups. The chain's counter rings an item straight through — a burger is tapped
// and it is on the order, with nothing asked in between — so the menu carries none and the
// register's options dialog never opens.
